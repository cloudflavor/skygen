...
impl<'a> CreateRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "v2/registries").require_body();

        Self { builder }
    }
    pub fn with_body(
        mut self,
        body: crate::models::multiregistry_create::MultiregistryCreate,
    ) -> Self {
...
impl<'a> ValidateNameRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder =
            ApiRequestBuilder::new(api, Method::POST, "v2/registries/validate-name").require_body();
