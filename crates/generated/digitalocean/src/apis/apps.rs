...
impl<'a> CreateRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "v2/apps")
            .require_body();

        Self { builder }
    }
    pub fn with_body(mut self, body: crate::models::apps_create_app_request::AppsCreateAppRequest) -> Self {
...
impl<'a> ListMetricsBandwidthDailyRequest<'a> {
    ...
    pub fn with_body(mut self, body: crate::models::app_metrics_bandwidth_usage_request::AppMetricsBandwidthUsageRequest) -> Self {
        self.builder = self.builder.json_body(body).expect("body serialization");
        self
    }
    pub async fn send(self) -> ApiResult<serde_json::Value> {
...
impl<'a> ValidateAppSpecRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "v2/apps/propose")
            .require_body();
...
impl<'a> GetInstanceSizeRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/apps/tiers/instance_sizes/{slug}");

        Self { builder }
    }
    pub fn with_slug(mut self, value: impl Into<String>) -> Self {
        self.builder = self.builder.header_param("slug", value);
        self
    }
    pub async fn send(self) -> ApiResult<serde_json::Value> {
        self.builder.send().await
...
impl<'a> ListAlertsRequest<'a> {
    ...
    pub fn with_app_id(mut self, value: impl Into<String>) -> Self {
        self.builder = self.builder.header_param("app_id", value);
        self
    }
    pub async fn send(self) -> ApiResult<serde_json::Value> {
        self.builder.send().await
...
impl<'a> AssignAlertDestinationsRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "v2/apps/{app_id}/alerts/{alert_id}/destinations")
            .require_body();
    ...
    pub fn with_body(mut self, body: crate::models::apps_assign_app_alert_destinations_request::AppsAssignAppAlertDestinationsRequest) -> Self {
        self.builder = self.builder.json_body(body).expect("body serialization");
        self
    }
    pub async fn send(self) -> ApiResult<serde_json::Value> {
...
impl<'a> GetExecActiveDeploymentRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/apps/{app_id}/components/{component_name}/exec");
    ...
    pub fn with_component_name(mut self, value: impl Into<String>) -> Self {
        self.builder = self.builder.header_param("component_name", value);
        self
    }
    pub async fn send(self) -> ApiResult<serde_json::Value> {
        self.builder.send().await
...
impl<'a> GetLogsActiveDeploymentRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/apps/{app_id}/components/{component_name}/logs");
...
impl<'a> CreateDeploymentRequest<'a> {
    ...
    pub fn with_body(mut self, body: crate::models::apps_create_deployment_request::AppsCreateDeploymentRequest) -> Self {
        self.builder = self.builder.json_body(body).expect("body serialization");
        self
    }
    pub async fn send(self) -> ApiResult<serde_json::Value> {
...
impl<'a> GetDeploymentRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/apps/{app_id}/deployments/{deployment_id}");
    ...
    pub fn with_deployment_id(mut self, value: impl Into<String>) -> Self {
        self.builder = self.builder.header_param("deployment_id", value);
        self
    }
    pub async fn send(self) -> ApiResult<serde_json::Value> {
        self.builder.send().await
...
impl<'a> CancelDeploymentRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "v2/apps/{app_id}/deployments/{deployment_id}/cancel");
...
impl<'a> GetExecRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/apps/{app_id}/deployments/{deployment_id}/components/{component_name}/exec");
...
impl<'a> GetLogsRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/apps/{app_id}/deployments/{deployment_id}/components/{component_name}/logs");
...
impl<'a> GetLogsAggregateRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/apps/{app_id}/deployments/{deployment_id}/logs");
...
impl<'a> GetMetricsBandwidthDailyRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/apps/{app_id}/metrics/bandwidth_daily");
...
impl<'a> RestartRequest<'a> {
    ...
    pub fn with_body(mut self, body: crate::models::apps_restart_request::AppsRestartRequest) -> Self {
        self.builder = self.builder.json_body(body).expect("body serialization");
        self
    }
    pub async fn send(self) -> ApiResult<serde_json::Value> {
...
impl<'a> CreateRollbackRequest<'a> {
    ...
    pub fn with_body(mut self, body: crate::models::apps_rollback_app_request::AppsRollbackAppRequest) -> Self {
        self.builder = self.builder.json_body(body).expect("body serialization");
        self
    }
    pub async fn send(self) -> ApiResult<serde_json::Value> {
...
impl<'a> ValidateRollbackRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "v2/apps/{app_id}/rollback/validate")
            .require_body();
...
impl<'a> GetRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/apps/{id}");
...
impl<'a> UpdateRequest<'a> {
    ...
    pub fn with_body(mut self, body: crate::models::apps_update_app_request::AppsUpdateAppRequest) -> Self {
        self.builder = self.builder.json_body(body).expect("body serialization");
        self
    }
    pub async fn send(self) -> ApiResult<serde_json::Value> {
...
impl<'a> DeleteRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::DELETE, "v2/apps/{id}");
