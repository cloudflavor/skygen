...
/// # Example
/// ```no_run
/// use digital_ocean_api::{ ApiClient, apis::container_registry };
...
impl<'a> CreateRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "v2/registry")
            .require_body();
...
impl<'a> ValidateNameRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "v2/registry/validate-name")
            .require_body();
...
impl<'a> GetGarbageCollectionRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/registry/{registry_name}/garbage-collection");
...
impl<'a> RunGarbageCollectionRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "v2/registry/{registry_name}/garbage-collection");
...
impl<'a> UpdateGarbageCollectionRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::PUT, "v2/registry/{registry_name}/garbage-collection/{garbage_collection_uuid}")
            .require_body();
...
impl<'a> ListGarbageCollectionsRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/registry/{registry_name}/garbage-collections");
...
impl<'a> ListRepositoriesRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/registry/{registry_name}/repositories");
...
impl<'a> ListRepositoryManifestsRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/registry/{registry_name}/repositories/{repository_name}/digests");
...
impl<'a> DeleteRepositoryManifestRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::DELETE, "v2/registry/{registry_name}/repositories/{repository_name}/digests/{manifest_digest}");
...
impl<'a> ListRepositoryTagsRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/registry/{registry_name}/repositories/{repository_name}/tags");
...
impl<'a> DeleteRepositoryTagRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::DELETE, "v2/registry/{registry_name}/repositories/{repository_name}/tags/{repository_tag}");
...
impl<'a> ListRepositoriesV2Request<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "v2/registry/{registry_name}/repositoriesV2");
