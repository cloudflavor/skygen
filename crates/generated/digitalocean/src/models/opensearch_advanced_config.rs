...
pub struct OpensearchAdvancedConfig {
    ...
    pub http_max_content_length_bytes: Option<i64>,
    pub http_max_header_size_bytes: Option<i64>,
    pub http_max_initial_line_length_bytes: Option<i64>,
    pub indices_fielddata_cache_size_percentage: Option<i64>,
    pub indices_memory_index_buffer_size_percentage: Option<i64>,
    pub indices_memory_max_index_buffer_size_mb: Option<i64>,
    pub indices_memory_min_index_buffer_size_mb: Option<i64>,
    pub indices_queries_cache_size_percentage: Option<i64>,
    pub indices_query_bool_max_clause_count: Option<i64>,
    pub indices_recovery_max_concurrent_file_chunks: Option<i64>,
    pub indices_recovery_max_mb_per_sec: Option<i64>,
    pub ism_enabled: Option<bool>,
    pub ism_history_enabled: Option<bool>,
    pub ism_history_max_age_hours: Option<i64>,
    pub ism_history_max_docs: Option<serde_json::Value>,
    pub ism_history_rollover_check_period_hours: Option<i64>,
    pub ism_history_rollover_retention_period_days: Option<i64>,
