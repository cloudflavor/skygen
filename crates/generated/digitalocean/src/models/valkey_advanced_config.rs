...
pub struct ValkeyAdvancedConfig {
    pub valkey_acl_channels_default: Option<String>,
    ...
    pub valkey_pubsub_client_output_buffer_limit: Option<i64>,
    pub valkey_ssl: Option<bool>,
    pub valkey_timeout: Option<i64>,
}
