...
pub struct AppsDeployment {
    ...
    pub static_sites: Option<Vec<crate::models::apps_deployment_static_site::AppsDeploymentStaticSite>>,
    pub tier_slug: Option<String>,
    pub updated_at: Option<String>,
    pub workers: Option<Vec<crate::models::apps_deployment_worker::AppsDeploymentWorker>>,
}
