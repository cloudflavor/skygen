...
use crate::models::scaleway_kafka_v1alpha1_list_versions_response::ScalewayKafkaV1alpha1ListVersionsResponse;
use crate::{ApiClient, ApiRequestBuilder, ApiResult};
use reqwest::Method;

#[derive(Debug)]
pub struct ListVersionsRequest<'a> {
    builder: ApiRequestBuilder<'a, ScalewayKafkaV1alpha1ListVersionsResponse>,
}

impl<'a> ListVersionsRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder =
            ApiRequestBuilder::new(api, Method::GET, "kafka/v1alpha1/regions/{region}/versions")
                .require_path("region");
    ...
    pub async fn send(self) -> ApiResult<ScalewayKafkaV1alpha1ListVersionsResponse> {
...
///
/// **HTTP Method:** `GET`
/// **Path:** `/kafka/v1alpha1/regions/{region}/versions`
///
/// **Parameters**
...
/// # Example
/// ```no_run
/// use clustersforapachekafka®::{ ApiClient, apis::kafka_versions };
