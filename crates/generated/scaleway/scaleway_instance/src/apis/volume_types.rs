...
use crate::models::scaleway_instance_v1_list_volumes_types_response::ScalewayInstanceV1ListVolumesTypesResponse;
use crate::{ApiClient, ApiRequestBuilder, ApiResult};
use reqwest::Method;

#[derive(Debug)]
pub struct ListVolumesTypesRequest<'a> {
    builder: ApiRequestBuilder<'a, ScalewayInstanceV1ListVolumesTypesResponse>,
}

impl<'a> ListVolumesTypesRequest<'a> {
    ...
    pub async fn send(self) -> ApiResult<ScalewayInstanceV1ListVolumesTypesResponse> {
...
/// # Example
/// ```no_run
/// use instance::{ ApiClient, apis::volume_types };
/// let api = ApiClient::builder("https://api.example.com").build().expect("client");
/// let response = list_volumes_types(&api)
///     .with_zone("zone")
...
///     .await?;
/// ```
pub fn list_volumes_types(api: &ApiClient) -> ListVolumesTypesRequest<'_> {
    ListVolumesTypesRequest::new(api)
}
