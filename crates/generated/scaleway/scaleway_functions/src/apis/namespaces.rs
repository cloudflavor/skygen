...
use crate::models::scaleway_functions_v1beta1_list_namespaces_response::ScalewayFunctionsV1beta1ListNamespacesResponse;
use crate::models::scaleway_functions_v1beta1_namespace::ScalewayFunctionsV1beta1Namespace;
use crate::{ApiClient, ApiRequestBuilder, ApiResult};
use reqwest::Method;

#[derive(Debug)]
pub struct ListNamespacesRequest<'a> {
    builder: ApiRequestBuilder<'a, ScalewayFunctionsV1beta1ListNamespacesResponse>,
}
...
impl<'a> ListNamespacesRequest<'a> {
    ...
    pub async fn send(self) -> ApiResult<ScalewayFunctionsV1beta1ListNamespacesResponse> {
...
/// # Example
/// ```no_run
/// use serverlessfunctions::{ ApiClient, apis::namespaces };
...
pub struct CreateNamespaceRequest<'a> {
    builder: ApiRequestBuilder<'a, ScalewayFunctionsV1beta1Namespace>,
}
...
impl<'a> CreateNamespaceRequest<'a> {
    ...
    pub async fn send(self) -> ApiResult<ScalewayFunctionsV1beta1Namespace> {
        self.builder.send().await
    }
}
...
///
/// **HTTP Method:** `GET`
/// **Path:** `/functions/v1beta1/regions/{region}/namespaces/{namespace_id}`
///
/// **Parameters**
/// - `region` (path, required)
