...
use crate::models::scaleway_functions_v1beta1_list_tokens_response::ScalewayFunctionsV1beta1ListTokensResponse;
use crate::models::scaleway_functions_v1beta1_token::ScalewayFunctionsV1beta1Token;
use crate::{ApiClient, ApiRequestBuilder, ApiResult};
use reqwest::Method;

#[derive(Debug)]
pub struct ListTokensRequest<'a> {
    builder: ApiRequestBuilder<'a, ScalewayFunctionsV1beta1ListTokensResponse>,
}
...
impl<'a> ListTokensRequest<'a> {
    ...
    pub async fn send(self) -> ApiResult<ScalewayFunctionsV1beta1ListTokensResponse> {
...
/// - `function_id` (query,optional)
/// - `namespace_id` (query,optional)
///
/// # Example
/// ```no_run
/// use serverlessfunctions::{ ApiClient, apis::tokens };
...
pub struct CreateTokenRequest<'a> {
    builder: ApiRequestBuilder<'a, ScalewayFunctionsV1beta1Token>,
}
...
impl<'a> CreateTokenRequest<'a> {
    ...
    pub async fn send(self) -> ApiResult<ScalewayFunctionsV1beta1Token> {
        self.builder.send().await
    }
}
