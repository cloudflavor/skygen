...
use reqwest::Method;
use crate::models::scaleway_interlink_v1beta1_list_routing_policies_response::ScalewayInterlinkV1beta1ListRoutingPoliciesResponse;
use crate::models::scaleway_interlink_v1beta1_routing_policy::ScalewayInterlinkV1beta1RoutingPolicy;

#[derive(Debug)]
pub struct ListRoutingPoliciesRequest<'a> {
    builder: ApiRequestBuilder<'a, ScalewayInterlinkV1beta1ListRoutingPoliciesResponse>,
}

impl<'a> ListRoutingPoliciesRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "interlink/v1beta1/regions/{region}/routing-policies")
            .require_path("region");
    ...
    pub async fn send(self) -> ApiResult<ScalewayInterlinkV1beta1ListRoutingPoliciesResponse> {
...
///
/// **HTTP Method:** `GET`
/// **Path:** `/interlink/v1beta1/regions/{region}/routing-policies`
///
/// **Parameters**
...
/// # Example
/// ```no_run
/// use interlink::{ ApiClient, apis::routing_policies };
...
pub struct CreateRoutingPolicyRequest<'a> {
    builder: ApiRequestBuilder<'a, ScalewayInterlinkV1beta1RoutingPolicy>,
}

impl<'a> CreateRoutingPolicyRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "interlink/v1beta1/regions/{region}/routing-policies")
            .require_path("region")
            .require_body();
    ...
    pub async fn send(self) -> ApiResult<ScalewayInterlinkV1beta1RoutingPolicy> {
        self.builder.send().await
    }
}
...
impl<'a> PolicyRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "interlink/v1beta1/regions/{region}/routing-policies/{routing_policy_id}")
            .require_path("region")
...
///
/// **HTTP Method:** `GET`
/// **Path:** `/interlink/v1beta1/regions/{region}/routing-policies/{routing_policy_id}`
///
/// **Parameters**
/// - `region` (path, required)
...
impl<'a> PolicyDeleteRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::DELETE, "interlink/v1beta1/regions/{region}/routing-policies/{routing_policy_id}")
            .require_path("region")
            .require_path("routing_policy_id");
...
impl<'a> UpdateRoutingPolicyRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::PATCH, "interlink/v1beta1/regions/{region}/routing-policies/{routing_policy_id}")
            .require_path("region")
            .require_path("routing_policy_id")
            .require_body();
