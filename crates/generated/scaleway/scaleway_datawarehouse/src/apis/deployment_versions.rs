...
use crate::models::scaleway_datawarehouse_v1beta1_list_versions_response::ScalewayDatawarehouseV1beta1ListVersionsResponse;
use crate::{ApiClient, ApiRequestBuilder, ApiResult};
use reqwest::Method;

#[derive(Debug)]
pub struct ListVersionsRequest<'a> {
    builder: ApiRequestBuilder<'a, ScalewayDatawarehouseV1beta1ListVersionsResponse>,
}
...
impl<'a> ListVersionsRequest<'a> {
    ...
    pub async fn send(self) -> ApiResult<ScalewayDatawarehouseV1beta1ListVersionsResponse> {
...
///
/// **HTTP Method:** `GET`
/// **Path:** `/datawarehouse/v1beta1/regions/{region}/versions`
///
/// **Parameters**
...
/// # Example
/// ```no_run
/// use datawarehouse::{ ApiClient, apis::deployment_versions };
