...
impl<'a> GetSinkholesRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder =
            ApiRequestBuilder::new(api, Method::GET, "accounts/{account_id}/intel/sinkholes")
...
///     .await?;
/// ```
pub fn get_sinkholes(api: &ApiClient) -> GetSinkholesRequest<'_> {
    GetSinkholesRequest::new(api)
}
