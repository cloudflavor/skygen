...
impl<'a> ListMonitorsRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "user/load_balancers/monitors");
...
/// # Example
/// ```no_run
/// use cloudflare_api::{ ApiClient, apis::load_balancer_monitors };
...
impl<'a> CreateMonitorRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::POST, "user/load_balancers/monitors")
            .require_body();
...
impl<'a> PreviewResultRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder =
            ApiRequestBuilder::new(api, Method::GET, "user/load_balancers/preview/{preview_id}")
