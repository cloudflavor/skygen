...
///     .await?;
/// ```
pub fn telemetry_values_list(api: &ApiClient) -> TelemetryValuesListRequest<'_> {
    TelemetryValuesListRequest::new(api)
}
