...
#[derive(Debug)]
pub struct PostRunCfHuggingfaceRequest<'a> {
    builder: ApiRequestBuilder<'a, std::collections::BTreeMap<String, serde_json::Value>>,
}

impl<'a> PostRunCfHuggingfaceRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(
            api,
            Method::POST,
...
///     .await?;
/// ```
pub fn post_run_cf_huggingface(api: &ApiClient) -> PostRunCfHuggingfaceRequest<'_> {
    PostRunCfHuggingfaceRequest::new(api)
}
