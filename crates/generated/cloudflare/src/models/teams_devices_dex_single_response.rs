...
pub struct TeamsDevicesDexSingleResponse {
    pub result: Option<crate::models::teams_devices_device_dex_test_schemas_http::TeamsDevicesDeviceDexTestSchemasHttp>,
    #[serde(flatten)]
