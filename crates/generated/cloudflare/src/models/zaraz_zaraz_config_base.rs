...
pub struct ZarazZarazConfigBase {
    pub analytics: Option<std::collections::BTreeMap<String, serde_json::Value>>,
    pub consent: Option<std::collections::BTreeMap<String, serde_json::Value>>,
    pub data_layer: bool,
    pub debug_key: String,
    pub history_change: Option<bool>,
    pub settings: std::collections::BTreeMap<String, serde_json::Value>,
    pub triggers: std::collections::BTreeMap<String, serde_json::Value>,
