...
#[derive(Debug)]
pub struct ListInstanceTypesRequest<'a> {
    builder: ApiRequestBuilder<'a, std::collections::BTreeMap<String, serde_json::Value>>,
}

impl<'a> ListInstanceTypesRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder = ApiRequestBuilder::new(api, Method::GET, "instance-type");
...
/// # Example
/// ```no_run
/// use exoscale_public_api::{ ApiClient, apis::instance_type };
/// let api = ApiClient::builder("https://api.example.com").build().expect("client");
/// let _ = list_instance_types(&api)
///     .send()
///     .await?;
/// ```
pub fn list_instance_types(api: &ApiClient) -> ListInstanceTypesRequest<'_> {
    ListInstanceTypesRequest::new(api)
}

#[derive(Debug)]
pub struct GetRequest<'a> {
    builder: ApiRequestBuilder<'a, InstanceType>,
}

impl<'a> GetRequest<'a> {
    pub fn new(api: &'a ApiClient) -> Self {
        let builder =
            ApiRequestBuilder::new(api, Method::GET, "instance-type/{id}").require_path("id");
    ...
    pub async fn send(self) -> ApiResult<InstanceType> {
        self.builder.send().await
    }
}
